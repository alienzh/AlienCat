 ...
 */
public class StandardVideoPlayer extends VideoControlView {
...
//            setViewShowState(mLockScreen, VISIBLE);
        ...
        } else if (mCurrentState == STATE_BUFFERING_START) {
            if (mBottomContainer != null) {
                if (mBottomContainer.getVisibility() == View.VISIBLE) {
...
//    }
     ...
     */
//    @Override
//    public BaseVideoPlayerView startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
